    ...
    {        
        ...
        {            
            ...
            for (int j = 0; j < lstGas.Count-1; j++)
            {
                ...
                txtSearchByName.AutoCompleteCustomSource.Add(lstGas[j].RestStopName.Remove(lstGas[j].RestStopName.IndexOf('(')));
            }
        ...
        private void rdoSearchByReststop_CheckedChanged(object sender, EventArgs e)
        {
