...
namespace Rest
{
    class RouteFac
    {
        ...
        public RouteFac(string batchMenu, string brand, string convenience, string direction, string serviceAreaCode, string serviceAreaName, string telNo, string truckSaYn, string routeName)
        {
